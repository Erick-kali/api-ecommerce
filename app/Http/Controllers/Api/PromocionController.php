...
class PromocionController extends Controller
{
    ...
    public function estadisticas()
    {
        ...
        // Cambié 'activo' por 'estado'
        $promocionesActivas = Promocion::where('estado', 'activo')->count();  // Activas
        $promocionesInactivas = Promocion::where('estado', 'inactivo')->count();  // Inactivas
    ...
    {
        // Cambié 'activo' por 'estado'
        $activas = Promocion::where('estado', 'activo')->count();  // Activas
        $inactivas = Promocion::where('estado', 'inactivo')->count();  // Inactivas
